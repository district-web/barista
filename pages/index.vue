<template>
  <div class="gradient leading-relaxed tracking-wide">
    <Nav />
    ...
    <div class="container mx-auto flex">
      <div class="">
        <div class="iphone">   
          ...
          <img class="iphoneScreen" src="~/assets/consume.png" />
        </div>
      </div>
      <div class="px-10">
        ...
        >
          Start track your caffeine consume
        </h1>
        <p
          class="
            leading-normal
        ...
        <div class="my-4 text-2xl md:text-2xl lg:text-2xl font-black">
              Track your daily consume
        </div>
        <a href="https://apps.apple.com/us/app/barista-caffeine-tracker/id1570223740?itsct=apps_box_badge&amp;itscg=30200" style="display: inline-block; overflow: hidden; border-top-left-radius: 13px; border-top-right-radius: 13px; border-bottom-right-radius: 13px; border-bottom-left-radius: 13px; width: 250px; height: 83px;"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83&amp;releaseDate=1626134400&h=77bc190509853802f6b1fa53f16bec51" alt="Download on the App Store" style="border-top-left-radius: 13px; border-top-right-radius: 13px; border-bottom-right-radius: 13px; border-bottom-left-radius: 13px; width: 250px; height: 83px;"></a>
        <!--<img src="https://tools-qr-production.s3.amazonaws.com/output/apple-toolbox/a0aec865c65d50bf39928de4e97b4ebf/4086d4e840f622f2025787ac36f4314f.png" width="128">-->
      </div>
    </div>
      ...
      <div class="text-center px-3 lg:px-0">
        <div class="flex mt-10">
          ...
          <div class="w-2/5 hidden md:block">
            ...
            <img class="iphoneScreen" src="~/assets/trend.png" />
          </div>
